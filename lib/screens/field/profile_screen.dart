...
class FieldProfileScreen extends StatelessWidget {
  ...
  const FieldProfileScreen({super.key, required this.user});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _divider(),
                  _infoRow(Icons.location_on, 'Assigned Station', station.id),
                  _divider(),
                  _infoRow(Icons.home_work, 'Village', station.villageName),
                  _divider(),
                  _infoRow(Icons.business, 'Block', station.blockName),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _infoRow(Icons.phone_android, 'Device ID', 'DEV-CG-2026-001'),
                  _divider(),
                  _infoRow(Icons.verified, 'Status', 'Registered'),
                  _divider(),
                  _infoRow(Icons.update, 'App Version', '1.0.0'),
                ],
              ),
            ),
